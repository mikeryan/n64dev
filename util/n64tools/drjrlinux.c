/*
    ...
    Compile: gcc -Wall -O2 -o drjr drjrlinux.c
...
*/
/*
 * compatibility modifications (ioperms, anyone?) by hcs
 */
...
void outport(unsigned int arg1,unsigned int arg2)
{
  outw(arg2,arg1);
}
